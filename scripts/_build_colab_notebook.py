...
cells.append(code([
    "# TRAIN_N train + 400 held-out per pure split, deterministic seeds. ~7-8 min on\n",
    "# Colab CPU at TRAIN_N=20000. Disjoint dirs per DATA_KIND.\n",
    "from pathlib import Path\n",
    "import subprocess\n",
    "\n",
    "tasks = [\n",
    "    (TRAIN_DIR, TRAIN_N, 0, BUILD_SCRIPT, BUILD_EXTRA),\n",
